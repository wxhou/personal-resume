...
Defines build-time static site generation and SEO metadata, covering vite-react-ssg prerendering of both routes, per-page title/description meta tags, Open Graph tags, JSON-LD Person structured data, and crawler files (robots.txt, sitemap.xml).
