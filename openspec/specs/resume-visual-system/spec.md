...
Defines the shared visual foundation across all resume themes: a CSS-variable-driven theming architecture, a unified animation system, and print-mode cleanup. This capability is the base layer that the dark, editorial, and geometric style capabilities build upon.
