...
Defines the editorial theme of the resume: a warm cream/off-white, high-end magazine spread aesthetic with deep charcoal text and a single vermillion accent. It specifies the color palette, typography, and component treatments (section labels, avatar, project layout, skill tags) for the editorial theme.
