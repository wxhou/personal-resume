...
Defines the resume page mounted at `/resume`, covering content parity with the original single-page resume, retention of the four-theme switcher, PDF/image export, and print adaptation.
