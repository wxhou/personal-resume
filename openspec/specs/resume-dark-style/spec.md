...
Defines the dark theme of the resume: a near-black, high-contrast precision aesthetic inspired by Linear/Vercel, with a single amber accent. It specifies the color palette, typography, and component treatments (header, project cards, timeline) for the dark theme.
