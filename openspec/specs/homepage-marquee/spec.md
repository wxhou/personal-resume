...
Defines the achievements marquee (成就滚动条) shown below the homepage hero — a seamless looping scroll of real, verifiable achievement data, implemented in pure CSS so the content is visible in SSG output.
