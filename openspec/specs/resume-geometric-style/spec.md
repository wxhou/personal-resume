...
Defines the geometric theme of the resume: a pure white, refined architectural aesthetic with deep navy text and a structural blue accent. It specifies the color palette, typography, SVG background decoration, and component treatments (avatar, project cards, skill tags, timeline) for the geometric theme.
