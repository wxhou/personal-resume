...
Defines the featured projects data model and its card-based presentation on the homepage, covering the manually maintained `src/data/featuredProjects.json` file, card content, and new-tab link behavior.
