...
Defines the multi-page routing for the personal site using react-router-dom, covering the homepage (`/`), resume page (`/resume`), navigation between them, and handling of unknown paths.
