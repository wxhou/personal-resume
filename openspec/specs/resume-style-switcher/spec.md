...
Defines the theme switcher UI that lets users switch between the dark, editorial, and geometric themes in real time. It covers the switcher's appearance, immediate theme switching behavior, state persistence, accessibility, and print-mode hiding.
