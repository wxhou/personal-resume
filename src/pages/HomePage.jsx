...
// 字体子集（构建期 scripts/subset-fonts.js 生成，见 openspec change perf-font-subset-idle-render）
  ...
  return (
    <div className="home-page fx-cursor">
      <Head>
        ...
        <meta property="og:image" content="https://wxhou.pages.dev/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:type" content="profile" />
        <meta property="og:url" content="https://wxhou.pages.dev/" />
